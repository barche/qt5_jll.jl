...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import qt5_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f6bcde8e-82ad-569a-80a3-2cbc66694a45"))
platforms = [Pkg.Artifacts.unpack_platform(e, "qt5", artifacts_toml) for e in artifacts["qt5"]]
...
if best_platform === nothing
    @debug("Unable to load qt5; unsupported platform $(triplet(platform_key_abi()))")
else
